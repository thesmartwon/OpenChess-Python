...
namespace Stockfish
{
    ...
    ExtMove* Stockfish::generate (const Position& pos, ExtMove* moveList)
    {
    ...
    //template Stockfish::ExtMove* generate<CAPTURES>(const Position&, ExtMove*);
    //template Stockfish::ExtMove* generate<QUIETS>(const Position&, ExtMove*);
    //template Stockfish::ExtMove* generate<NON_EVASIONS>(const Position&, ExtMove*);


    /// generate<QUIET_CHECKS> generates all pseudo-legal non-captures and knight
    /// underpromotions that give check. Returns a pointer to the end of the move list.
    template<>
    ExtMove* Stockfish::generate<QUIET_CHECKS> (const Position& pos, ExtMove* moveList)
    {
    ...
    template<>
    ExtMove* Stockfish::generate<EVASIONS> (const Position& pos, ExtMove* moveList)
    {
    ...
    template<>
    ExtMove* Stockfish::generate<LEGAL> (const Position& pos, ExtMove* moveList)
    {
        ...
        moveList = pos.checkers () ? Stockfish::generate<EVASIONS    > (pos, moveList)
            : Stockfish::generate<NON_EVASIONS> (pos, moveList);
        while (cur != moveList)
